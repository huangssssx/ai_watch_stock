...
# The optimized V5.1 script content
V5_SCRIPT_CONTENT = """# ==============================================================================
...
def update_rule_script():
    ...
    try:
        ...
        for rule in rules:
            ...
            rule.code = V5_SCRIPT_CONTENT
            rule.description = "捕捉处于下跌趋势或低位盘整中，出现技术面反转信号的股票。V5.1优化版：引入RSI(Wilder)<35、布林带下轨支撑、量能确认等高胜率条件。"
            session.commit()
